...
% Total balance
axbal(1) = subplot('position',[margin 1.15*height width height]); box on; hold on; % For integrated internal energy balance
...
axbal(2) = subplot('position',[width+2*margin 1.15*height width height]); box on; hold on; % For decomposition of upstream internal energy fluxes
position = get(axbal(2),'Position'); lgd = legend(axbal(2),'show','location','southoutside');
set(axbal(2), 'Position', position);       
        
% Decomposition of downstrean fluxes
axbal(3) = subplot('position',[2*width+3*margin 1.15*height width height]); box on; hold on; % For decomposition of downstream internal energy fluxes
...
axbal(4) = subplot('position',[3*width+4*margin 1.15*height width height]); box on; hold on; % For decomposition of internal energy sources
...
% Total balance
axbal(5) = subplot('position',[margin 1.15*height width height]); box on; hold on; % For poloidal internal energy balance
...
axbal(6) = subplot('position',[width+2*margin 1.15*height width height]); box on; hold on; % For decomposition of internal energy fluxes
...
axbal(7) = subplot('position',[2*width+3*margin 1.15*height width height]); box on; hold on; % For decomposition of internal energy sources
