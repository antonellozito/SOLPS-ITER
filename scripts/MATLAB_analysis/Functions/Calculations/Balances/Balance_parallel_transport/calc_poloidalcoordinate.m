function [x_pol,x_poledge] = calc_poloidalcoordinate(gmtry,indbal,default_region,polbaldist)
%
% calc_poloidalcoordinate calculates the poloidal coordinate of the poloidal balance plots
%
%% CALCULATION
...
if ismember(default_region(2),'o')
