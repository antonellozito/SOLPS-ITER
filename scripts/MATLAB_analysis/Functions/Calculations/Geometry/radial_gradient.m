function dfieldr = radial_gradient(gmtry,field)
%
% Compute the radial difference of a cell centered field, at both x and y surfaces
% Takes into account grid distortion (9-point stencil)
%
...
fieldc = interp_corners(gmtry,field,'vol');
...
qzf = interp_face(gmtry,gmtry.qz(:,:,1),1,'vol');
...
qzf = interp_face(gmtry,gmtry.qz(:,:,1),2,'vol');
