function fieldI = interp_corners(gmtry,field,meth)
%
% Interpolate a cell centered field to cell corners. Only volume weighted interpolation is implemented for now
%
...
switch meth
    ...
    otherwise
        ...
        error('Error: interp_corners -- unknown value of meth.');
