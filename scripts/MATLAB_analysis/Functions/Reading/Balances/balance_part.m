function [rb,pb] = balance_part(transport_mode,varargin)
...
if strata_plot
    strata_plots(transport_mode,{squeeze(eirene_mc_papl_sna)},{squeeze(eirene_mc_pmpl_sna)},{squeeze(eirene_mc_pipl_sna)},{squeeze(eirene_mc_pppl_sna)},...
