function [rb,pb] = balance_toten(transport_mode,varargin)
...
rb = radial_balance(transport_mode,...
    ...
    cat(3,...
        ...
        b2stel_shi_ion+b2stel_shi_rec+b2stcx_shi,... % Atomic processes
...
if strata_plot
    strata_plots(transport_mode,{eirene_mc_eael_she/1E6+eirene_mc_eapl_shi/1E6},{eirene_mc_emel_she/1E6+eirene_mc_empl_shi/1E6},...
