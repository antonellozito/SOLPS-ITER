...
nstrai = read_namelist_scalar_int(nml_str, 'nstrai');
...
function descriptions = read_neutrals_descriptions(SOLPSTOP, ~)
    descriptions = read_b2input_descriptions(SOLPSTOP, 'b2.neutrals.parameters');
end
