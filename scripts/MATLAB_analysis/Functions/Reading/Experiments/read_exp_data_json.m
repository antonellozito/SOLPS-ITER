...
category_structure.MIDPLANE.INNER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                    'ION_TEMPERATURE', 'ION_SPECIES_DENSITY'};
category_structure.MIDPLANE.OUTER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                    'ION_TEMPERATURE', 'ION_SPECIES_DENSITY'};
category_structure.CHORDS.PROFILES = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                 'ION_TEMPERATURE', 'ION_SPECIES_DENSITY'};
category_structure.CHORDS.INTEGRALS = {'PHOTON_EMISSION', 'RADIATED_POWER'};
category_structure.TARGETS.LOWER_INNER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                       'PARTICLE_FLUX_DENSITY', 'ENERGY_FLUX_DENSITY'};
category_structure.TARGETS.LOWER_OUTER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                       'PARTICLE_FLUX_DENSITY', 'ENERGY_FLUX_DENSITY'};
category_structure.TARGETS.UPPER_INNER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                       'PARTICLE_FLUX_DENSITY', 'ENERGY_FLUX_DENSITY'};
category_structure.TARGETS.UPPER_OUTER = {'ELECTRON_DENSITY', 'ELECTRON_TEMPERATURE', ...
                                       'PARTICLE_FLUX_DENSITY', 'ENERGY_FLUX_DENSITY'};

% Define all possible attributes
all_attributes = {'SHOT', 'SOURCE', 'EXPERIMENT', 'VERSION', 'SIGNAL', ...
                 'SIGNAL_UNCERTAINTY', 'SPECIES', 'EMISSION_LINE', ...
                 'SHIFT', 'CHORDS', 'TIME_START', 'TIME_END', 'REDUCED_SET_TIME_DELTA', ...
                 'NAME_DISPLAY'};
...
function subsub = initialize_subsubcategory(attributes, n_elements)
    ...
    for i = 1:length(attributes)
        ...
        if ismember(attr, {'EMISSION_LINE', 'SHIFT', 'CHORDS', ...
