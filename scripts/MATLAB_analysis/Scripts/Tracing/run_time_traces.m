    ...
    for i = 1:ncut
        ...
        while is <= ns
            ...
            if charge_state(is)==0
                try
                    timeplot(TIME_TRACES.timesa.value, ...
                        struct('data',squeeze(TIME_TRACES.dabsepm.value(iatm,i,:))', 'color',COLOR_DENSITIES, 'display_name',labels_midplane{i}, 'line_style','-'), ...
                        'OriginalTime', orig_time, ...
                        'OriginalTraces', {get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'dabsepm', iatm, i)}, ...
                        'YLabel',sp_ylabel, 'Title',sp_title, tp_common{:});
                catch
                    timeplot(TIME_TRACES.timesa.value, ...
                        struct('data',squeeze(TIME_TRACES.nasepm.value(is,i,:))', 'color',COLOR_DENSITIES, 'display_name',labels_midplane{i}, 'line_style','-'), ...
                        'OriginalTime', orig_time, ...
                        'OriginalTraces', {get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'nasepm', is, i)}, ...
                        'YLabel',sp_ylabel, 'Title',sp_title, tp_common{:});
                end
                iatm = iatm+1;
            else
    ...
    for i = 1:ncut
        ...
        while is <= ns
            ...
            if charge_state(is)==0
                try
                    timeplot(TIME_TRACES.timesa.value, ...
                        [struct('data',squeeze(TIME_TRACES.dabsepi.value(iatm,i,:))', 'color',COLOR_DENSITIES_LIGHT, 'display_name',labels_divertor{i}{1}, 'line_style','-'), ...
                         struct('data',squeeze(TIME_TRACES.dabsepa.value(iatm,i,:))', 'color',COLOR_DENSITIES_DARK,  'display_name',labels_divertor{i}{3}, 'line_style','-')], ...
                        'OriginalTime', orig_time, ...
                        'OriginalTraces', {get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'dabsepi', iatm, i), ...
                                           get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'dabsepa', iatm, i)}, ...
                        'YLabel',sp_ylabel, 'Title',sp_title, tp_common{:});
                catch
                    timeplot(TIME_TRACES.timesa.value, ...
                        [struct('data',squeeze(TIME_TRACES.nasepi.value(is,i,:))',  'color',COLOR_DENSITIES_LIGHT, 'display_name',labels_divertor{i}{1}, 'line_style','-'), ...
                         struct('data',squeeze(TIME_TRACES.namxip.value(is,i,:))',  'color',COLOR_DENSITIES_LIGHT, 'display_name',labels_divertor{i}{2}, 'line_style',':'), ...
                         struct('data',squeeze(TIME_TRACES.nesepa.value(is,i,:))',  'color',COLOR_DENSITIES_DARK,  'display_name',labels_divertor{i}{3}, 'line_style','-'), ...
                         struct('data',squeeze(TIME_TRACES.namxap.value(is,i,:))',  'color',COLOR_DENSITIES_DARK,  'display_name',labels_divertor{i}{4}, 'line_style',':')], ...
                        'OriginalTime', orig_time, ...
                        'OriginalTraces', {get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'nasepi', is, i), ...
                                           get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'namxip', is, i), ...
                                           get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'nesepa', is, i), ...
                                           get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'namxap', is, i)}, ...
                        'YLabel',sp_ylabel, 'Title',sp_title, tp_common{:});
                end
                iatm = iatm+1;
            else
                timeplot(TIME_TRACES.timesa.value, ...
                    [struct('data',squeeze(TIME_TRACES.nasepi.value(is,i,:))',  'color',COLOR_DENSITIES_LIGHT, 'display_name',labels_divertor{i}{1}, 'line_style','-'), ...
                     struct('data',squeeze(TIME_TRACES.namxip.value(is,i,:))',  'color',COLOR_DENSITIES_LIGHT, 'display_name',labels_divertor{i}{2}, 'line_style',':'), ...
                     struct('data',squeeze(TIME_TRACES.nasepa.value(is,i,:))',  'color',COLOR_DENSITIES_DARK,  'display_name',labels_divertor{i}{3}, 'line_style','-'), ...
                     struct('data',squeeze(TIME_TRACES.namxap.value(is,i,:))',  'color',COLOR_DENSITIES_DARK,  'display_name',labels_divertor{i}{4}, 'line_style',':')], ...
                    'OriginalTime', orig_time, ...
                    'OriginalTraces', {get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'nasepi', is, i), ...
                                       get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'namxip', is, i), ...
                                       get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'nasepa', is, i), ...
                                       get_orig_3d(HAS_AVERAGING, PLOT_ORIGINAL_DATA, TIME_TRACES_ORIGINAL, 'namxap', is, i)}, ...
                    'YLabel',sp_ylabel, 'Title',sp_title, tp_common{:});
            end
            is = is+1;
