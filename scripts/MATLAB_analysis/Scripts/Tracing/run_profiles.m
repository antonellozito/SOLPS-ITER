...
% Select the radial distance ('rhop' or 'dssep')
...
PARAMS(end+1) = struct('name', 'EXP_DATA_MIDPLANE_ELECTRON_DENSITY_TYPES', 'type', 'char', ...
...
PARAMS(end+1) = struct('name', 'EXP_DATA_MIDPLANE_ELECTRON_TEMPERATURE_TYPES', 'type', 'char', ...
    'default', EXP_DATA_MIDPLANE_ELECTRON_TEMPERATURE_TYPES, 'required', false, ...
    'comment', 'Types of exp data plots for midplane Te', ...
    'validator', @(x) iscell(x) || ischar(x));

PARAMS(end+1) = struct('name', 'EXP_DATA_MIDPLANE_ION_TEMPERATURE_TYPES', 'type', 'char', ...
    'default', EXP_DATA_MIDPLANE_ION_TEMPERATURE_TYPES, 'required', false, ...
    'comment', 'Types of exp data plots for midplane Ti', ...
    'validator', @(x) iscell(x) || ischar(x));

PARAMS(end+1) = struct('name', 'EXP_DATA_MIDPLANE_ION_SPECIES_DENSITY_TYPES', 'type', 'char', ...
...
PARAMS(end+1) = struct('name', 'EXP_DATA_TARGETS_ELECTRON_DENSITY_TYPES', 'type', 'char', ...
    'default', EXP_DATA_TARGETS_ELECTRON_DENSITY_TYPES, 'required', false, ...
    'comment', 'Types of exp data plots for target ne', ...
    'validator', @(x) iscell(x) || ischar(x));

PARAMS(end+1) = struct('name', 'EXP_DATA_TARGETS_ELECTRON_TEMPERATURE_TYPES', 'type', 'char', ...
    'default', EXP_DATA_TARGETS_ELECTRON_TEMPERATURE_TYPES, 'required', false, ...
    'comment', 'Types of exp data plots for target Te', ...
    'validator', @(x) iscell(x) || ischar(x));

PARAMS(end+1) = struct('name', 'EXP_DATA_TARGETS_PARTICLE_FLUX_DENSITY_TYPES', 'type', 'char', ...
...
PARAMS(end+1) = struct('name', 'EXP_DATA_TARGETS_ENERGY_FLUX_DENSITY_TYPES', 'type', 'char', ...
...
PARAMS(end+1) = struct('name', 'EXP_DATA_TARGETS_ENERGY_FLUX_DENSITY_COLORS', 'type', 'char', ...
...
color_name_to_index = containers.Map({'blue','red','yellow','purple','green','cyan','magenta'},{1,2,3,4,5,6,7});
...
if PLOT_EXP_DATA_MIDPLANE || PLOT_EXP_DATA_TARGETS
    for i = 1:length(PAST_COLORS_DENSITIES)
        PAST_COLORS_DENSITIES{i}(4) = 0.1;
    end
    for i = 1:length(PAST_COLORS_TEMPERATURES)
        PAST_COLORS_TEMPERATURES{i}(4) = 0.1;
    end
end
...
if PLOT_OUTER_MIDPLANE_PROFILES
    ...
    profileplot(x_OMP, PROFILES.ne3da.value(:,end), ...
        ...
        'ExpData', exp_ne, 'ExpDataTypes', EXP_DATA_MIDPLANE_ELECTRON_DENSITY_TYPES, ...
    ...
    profileplot(x_OMP, PROFILES.te3da.value(:,end), ...
        ...
        'ExpData', exp_Te, 'ExpDataTypes', EXP_DATA_MIDPLANE_ELECTRON_TEMPERATURE_TYPES, ...
    ...
    profileplot(x_OMP, PROFILES.ti3da.value(:,end), ...
        ...
        'PastColors', PAST_COLORS_TEMPERATURES, pp_past{:}, ...
        'ExpData', exp_Ti, 'ExpDataTypes', EXP_DATA_MIDPLANE_ION_TEMPERATURE_TYPES, ...
...
if PLOT_OUTER_DIVERTOR_TARGET_PROFILES
    ...
    for t = 1:numel(outer_targets)
        ...
        profileplot(x_tgt, PROFILES.(sprintf('ne3d%s',sfx)).value(:,end), ...
            ...
            'PastColors', PAST_COLORS_DENSITIES, pp_past{:}, ...
            'ExpData', exp_ne, 'ExpDataTypes', EXP_DATA_TARGETS_ELECTRON_DENSITY_TYPES, ...
        ...
        profileplot(x_tgt, PROFILES.(sprintf('te3d%s',sfx)).value(:,end), ...
            ...
            'PastColors', PAST_COLORS_TEMPERATURES, pp_past{:}, ...
            'ExpData', exp_Te, 'ExpDataTypes', EXP_DATA_TARGETS_ELECTRON_TEMPERATURE_TYPES, ...
...
if PLOT_TARGET_LOAD_PROFILES
    ...
    for g = 1:numel(load_groups)
        ...
        profileplot(ot.x, fo_outer, ...
            ...
            'ExpData', exp_gamma_ot, 'ExpDataTypes', EXP_DATA_TARGETS_PARTICLE_FLUX_DENSITY_TYPES, ...
        ...
        profileplot(ot.x, ft_outer, ...
            ...
            'ExpData', exp_q_ot, 'ExpDataTypes', EXP_DATA_TARGETS_ENERGY_FLUX_DENSITY_TYPES, ...
        ...
        profileplot(it.x, fo_inner, ...
            ...
            'ExpData', exp_gamma_it, 'ExpDataTypes', EXP_DATA_TARGETS_PARTICLE_FLUX_DENSITY_TYPES, ...
            'ExpDataColors', EXP_DATA_TARGETS_PARTICLE_FLUX_DENSITY_COLORS, pp_exp{:}, ...
            pp_latest_ne{:}, ...
            'XLabel', RADIAL_LABEL, 'YLabel', '$\Gamma_{\perp}$ [m$^{-2}$s$^{-1}$]', ...
        ...
        profileplot(it.x, ft_inner, ...
            ...
            'ExpData', exp_q_it, 'ExpDataTypes', EXP_DATA_TARGETS_ENERGY_FLUX_DENSITY_TYPES, ...
            'ExpDataColors', EXP_DATA_TARGETS_ENERGY_FLUX_DENSITY_COLORS, pp_exp{:}, ...
            pp_latest_te{:}, ...
            'XLabel', RADIAL_LABEL, 'YLabel', '$Q_{\perp}$ [W/m$^2$]', ...
